<section class="sv products-sv" id="products">
  <h1 class="sv__page-title">
    <span class="jp">Pシリーズ</span>
    <span class="en">P SERIES</span>
  </h1>
</section>
...
<section class="series-instructions">
  <div class="wrap">
    <figure class="series-instructions__btn">
      <a href="<?php echo get_template_directory_uri();?>/assets/pdf/p.pdf" target="_blank">
...
<section class="series-first">
  <div class="wrap">
    ...
    <figure class="series-first__only-main">
      <?php echo webp('p_series', 'main');?>
    </figure>
    <figure class="series-first__icons">
      <picture>
        <?php echo webp2('p_series', 'icons');?>
      </picture>
    </figure>
  </div>
</section>
...
<section class="series-special" id="special">
  <div class="wrap">
    ...
    <article class="series-special__contena">
      ...
      <div class="series-special__dobble">
        <p class="series-special__dobble--text">
          同じフェイスデザインで55型から、最大86型までのラインナップをご用意。教室の広さや、授業での活用方法に合わせて最適なサイズをお選びいただけます。
        </p>
        <figure class="series-special__dobble--image">
          <?php echo webp('p_series', 'lineup');?>
        </figure>
      </div>
    </article>
    <article class="series-special__contena">
      ...
      <div class="series-special__dobble">
        <p class="series-special__dobble--text">
          電子黒板のネットワーク設定や初期化など重要な項目は、特定のユーザーしか行えない管理者機能を搭載。誤操作やイタズラを防止し、安心してご利用いただけます。
        </p>
        <figure class="series-special__dobble--image">
          <?php echo webp('p_series', 'admin');?>
        </figure>
      </div>
    </article>
    <article class="series-special__contena">
      ...
      <div class="series-special__dobble">
        <p class="series-special__dobble--text">
          使う先生・生徒の目線に立って、製品の企画・開発を行っています。全モデル共通で色補正機能を搭載し、色覚多様性にも対応。電源コンセントは2ピンのため変換プラグは不要。安心・安全にご利用いただけます。

        </p>
        <figure class="series-special__dobble--image">
          <?php echo webp('p_series', 'mesen');?>
        </figure>
      </div>
    </article>
  </div>
  ...
  <div class="wrap">
    ...
    <article class="series-mirror__flex">
      ...
      <div class="series-mirror__single">
        ...
        <figure class="image">
          <?php echo svg('p_series', 'mirror-icon2');?>
        </figure>
        <p class="text">
          会議ソフトZOOMを<br>
          アプリインストール
      ...
      <div class="series-mirror__single">
        ...
        <figure class="image">
          <?php echo svg('p_series', 'mirror-icon3');?>
        </figure>
        <p class="text">
          電子黒板上で<br>
          インターネット閲覧が可能
      ...
      <div class="series-mirror__single">
        ...
        <figure class="image">
          <?php echo svg('p_series', 'mirror-icon4');?>
        </figure>
        <p class="text">
          電子黒板専用の
          アンチウイルスソフトを搭載
